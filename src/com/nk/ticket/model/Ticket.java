...
public class Ticket {
	...
	public Ticket(String train_no, String station_train_code,
			...
			String to_station_telecode, String to_station_name,
			String start_time, String arrive_time, String day_difference,
			String train_class_name, String lishi, String canWebBuy,
			String lishiValue, String yp_info, String control_train_day,
			String start_train_date, String seat_feature, String yp_ex,
			String train_seat_feature, String seat_types, String location_code,
			String from_station_no, String to_station_no, String control_day,
			String sale_time, String is_support_card, String note,
			String controlled_train_flag, String controlled_train_message,
